...
confidenceInt1 <- sum(hyptestData$EZj) + c(-1,1)* 2*sqrt(sum(hyptestData$VarZj))
teststatistic1 <- sum(hyptestData$Zj)
...
confidenceInt2 <- sum(hyptestData$EZj) + c(-1,1)* 2*sqrt(sum(hyptestData$VarZj))
